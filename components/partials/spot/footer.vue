<template>
    <div :class="
        !SpotPage
          ? '2xl:mx-auto xl:mx-auto xl:max-w-screen-2xl 2xl:max-w-screen-2xl pb-4 pl-8 xl:py-6 xl:px-8'
          : 'mb-8 mt-20 xl:my-20 xl:max-w-screen-laptop-screen xl:px-32 xl:mx-auto 2xl:max-w-screen-2xl xl:mx-auto 2xl:mx-auto'
      ">
        <div class="flex items-center flex-wrap xl:flex-nowrap">
          <div  class="flex order-1  w-1/2 xl:pl-1 pl-4 xl:w-full">
            ...
            <div :class="!SpotPage?'flex items-center order-1 xl:mx-32 2xl:mr-72':'flex justify-evenly items-center xl:mx-4 2xl:mx-32 order-2 xl:max-w-screen-laptop-screen w-full pt-20 xl:pt-1 xl:order-1'">
