  ...
  <div class="h-full w-full flex flex-wrap bg-home">
    <div class="flex relative flex-col w-full overflow-hidden">
      ...
      <div class="flex w-full bg-dark-hero">
        ...
        <egg-component position='absolute' top='-56px' left='-1133px' width='27rem' opacity='0.1' border='2px solid' borderLeft='0px' borderBottom='0px' borderRadius='40px' height='204rem' zIndex='24' transform='rotate(37deg)' icon="/images/vector30.svg"></egg-component>
        <egg-component position='absolute' top='142px' left='-1187px' width='27rem' opacity='0.1' border='2px solid' borderLeft='0px' borderBottom='0px' borderRadius='40px' height='204rem' zIndex='24' transform='rotate(37deg)' icon="/images/vector31.svg"></egg-component>
      </div>
    </div>
