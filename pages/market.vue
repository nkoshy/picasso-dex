<template>
  <div class="h-full w-full flex flex-wrap py-0 bg-market-pattern">
    <!-- <div class="w-full">
      <div class="container">
    ...
    <app-header  market landingPage/>
    <h1
      class="text-white text-3xl xl:text-5xl  font-bold font-sora text-center my-14 px-8"
    >
      Markets
    </h1>
